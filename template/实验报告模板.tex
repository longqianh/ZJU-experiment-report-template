...
% titlepage格式可以自己调
	...
	\vspace*{1cm}
    \begin{center}
            \Large \makebox[4em][s]{实验名称}\ \ \underline{\makebox[220pt]{Title here}} \\ 
            \vspace{0.3cm}
            \Large \makebox[4em][s]{姓\hspace{\fill}名}\ \ \underline{\makebox[220pt]{Peter H}} \\ 
            \vspace{0.3cm}
            \Large \makebox[4em][s]{学\hspace{\fill}号}\ \ \underline{\makebox[220pt]{3180xxxxxx}}\\
            \vspace{0.3cm}
            \Large \makebox[4em][s]{实验地点}\ \ \underline{\makebox[220pt]{蓝田}}\\
            \vspace{0.3cm}
            \Large \makebox[4em][s]{实验日期}\ \ \underline{\makebox[220pt]{2020年 mm 月 dd 日}}\\
            \vspace{0.3cm}
            \Large \makebox[4em][s]{指导老师}\ \ \underline{\makebox[220pt]{Peter’s Instructors}}\\
